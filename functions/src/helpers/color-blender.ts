export class ColorBlender {
  static blendColors(color1, color2, percentage): String {
    return blend_colors(color1, color2, percentage)
  }
}
...
*/
function blend_colors(first, second, perc)
{
    // check input
    let color1 = first || '#000000';
    let color2 = second || '#ffffff';
    let percentage = perc || 0.5;
